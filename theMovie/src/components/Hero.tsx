...
export const Hero: React.FC = (): JSX.Element => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: movieSelected !== undefined
        ...
        <div className="text-center w-full">
          {movieSelected !== undefined
            ...
            <div className=" text-left">
              ...
              <p className="md:text-lg text-md text-white"><b>Release:</b> {formatDate(movieSelected.release_date)}</p>
              <p className="md:text-lg text-md text-white"><b>Vote:</b> {movieSelected.vote_average}</p>
            </div>
              )
            : (
              <Loading />
